                ...
                >
                    {features.map((feature) => (
                        <motion.div
                            ...
                            whileHover={{ y: -5 }}
                        >
                            <div className="bg-card dark:bg-card rounded-2xl p-6 shadow-lg border border-primary/20 hover:border-primary/40 hover:shadow-xl transition-all duration-300 h-full" style={{ boxShadow: '0 4px 20px rgba(0, 194, 224, 0.15)' }}>
                                {/* Icon */}
